...
public class OpenOneRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ResultBean.SeckillInfoBean data;
//    private final List<ResultBean.SeckillInfoBean.ListBean> list;

    public OpenOneRecycleAdapter(Context mContext) {
...
//        list = data.getList();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new OpenOneRecycleAdapter.MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_new_game, null));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        OpenOneRecycleAdapter.MyViewHolder myViewHolder = (OpenOneRecycleAdapter.MyViewHolder) holder;
