...
public class OpenTwoRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ResultBean.SeckillInfoBean data;
//    private final List<ResultBean.SeckillInfoBean.ListBean> list;

    public OpenTwoRecycleAdapter(Context mContext) {
...
//        list = data.getList();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new OpenTwoRecycleAdapter.MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_new_game, null));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        OpenTwoRecycleAdapter.MyViewHolder myViewHolder = (OpenTwoRecycleAdapter.MyViewHolder) holder;
...
//            });
    ...
    private SeckillRecyclerViewAdapter.OnSeckillRecyclerView onSeckillRecyclerView;
